...
| `ARR_PUBLIC_QUALITY_PROFILE`   | Managed Sonarr/Radarr quality profile name. The profile prefers 4K, falls back to 1080p or lower, disables CAM quality, and prefers English-language releases without blocking other languages.        | `Public 4K Preferred`                            |
